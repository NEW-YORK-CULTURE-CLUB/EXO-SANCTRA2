...
const defaultAvatars = [
  "https://media.licdn.com/dms/image/v2/D4E03AQFix5zJ7lWobQ/profile-displayphoto-shrink_200_200/B4EZYxzx9iHgAY-/0/1744592380934?e=2147483647&v=beta&t=yK-NgUJKrlMVHLFdslSUmdcXjrW-Hhrn44wG1I_YJCM",
  "/vault/br.jpg",
  "/vault/patrick.png",
  "/vault/risa.jpg",
]
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: "real-time" | "daily" | "weekly") => updateNotificationSettings({ ...settings.notifications, frequency: value as "real-time" | "daily" | "weekly" })}
                >
                      ...
                      <Switch
                        ...
                        onChange={(e) =>
                          updatePrivacySettings({ 
                            ...settings.privacy, 
                            analyticsSharing: (e.target as HTMLInputElement).checked 
                          })
                        }
                      />
                    </div>
...
onChange={(e) =>
  updatePrivacySettings({ 
    ...settings.privacy, 
    personalizedAds: (e.target as HTMLInputElement).checked 
  })
}
                      />
                    </div>
                  ...
                  <CardContent>
                    <RadioGroup
                      ...
                      onChange={(e) =>
                        updatePrivacySettings({ 
                          ...settings.privacy, 
                          visibility: (e.target as HTMLInputElement).checked ? 'public' : 'private' 
                        })
                      }                    >
                      <div className="flex items-center space-x-2">
