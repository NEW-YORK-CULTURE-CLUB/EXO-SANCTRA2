...
const AddNewCollectible = () => {
  ...
  const handleSubmit = async () => {
    if (!form.title || !form.seriesSetName || !form.modelVersionSku || !form.releaseYearEra || !form.manufacturerBrand || !form.width || !form.height || !form.price || !form.priceType || !form.location || !form.condition || !form.matureContent) {
      toast({
    ...
    if (!form.images || form.images.length === 0) {
      toast({
        title: "Validation Error",
        description: "At least one image is required. Please upload at least one image of the collectible.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      console.log('Starting collectible creation...');
      ...
      const collectibleData = {
        ...
        variantParallel: form.variantParallel,
        modelVersionSku: form.modelVersionSku,
        releaseYearEra: form.releaseYearEra,
        manufacturerBrand: form.manufacturerBrand,
        serialLotNumber: form.serialLotNumber,
        gradingService: form.gradingService,
        grade: form.grade,
        ...
        originalPackagingStatus: form.originalPackagingStatus,
      ...
      console.log('Prepared collectible data:', collectibleData);
      ...
      const collectibleId = await CollectibleService.createCollectible(collectibleData, galleryInfo);
      
      console.log('Collectible created successfully with ID:', collectibleId);
      ...
      toast({
        title: "Success!",
        description: `Collectible "${form.title}" has been added successfully.`,
      });
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to create collectible. Please try again.",
        variant: "destructive",
      });
    } finally {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground -mt-5">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-2xl font-bold mb-2">Add New Collectible</div>
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-6">
              ...
              <CardContent className="pt-6 pb-6 flex flex-col items-center">
                <div className="w-full flex flex-col items-center justify-center">
                  ...
                  <label htmlFor="images-upload" className="w-full h-40 rounded-lg flex flex-col items-center justify-center cursor-pointer mb-4 transition-colors">
                    ...
                    <span className="mt-2 font-semibold text-center text-lg w-full">Upload Collectible Media</span>
          ...
          <div className="flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <div className="mb-1 font-medium">Series / Set Name *</div>
                <Input 
                  name="seriesSetName"
              ...
              <div>
                <div className="mb-1 font-medium">Edition / Run Size</div>
                <Input 
                  name="editionRunSize"
                  placeholder="e.g., 1st Edition, Limited to 1000" 
              ...
              <div>
                <div className="mb-1 font-medium">Variant / Parallel</div>
                <Input 
                  name="variantParallel"
                  placeholder="e.g., Holographic, Gold Parallel" 
                  value={form.variantParallel}
                  onChange={handleInput}
                />
                <div className="text-xs text-muted-foreground mt-1">Optional</div>
              </div>
              <div>
                <div className="mb-1 font-medium">Model / Version / SKU *</div>
                <Input 
                  name="modelVersionSku"
                  placeholder="e.g., PIK-001, Limited Edition" 
                  value={form.modelVersionSku}
                  onChange={handleInput}
                />
              </div>
              <div>
                <div className="mb-1 font-medium">Release Year / Era *</div>
                <Input 
                  name="releaseYearEra"
                  placeholder="e.g., 1999, 1980s" 
                  value={form.releaseYearEra}
                  onChange={handleInput}
                />
              </div>
              <div>
                <div className="mb-1 font-medium">Manufacturer / Brand *</div>
                <Input 
              ...
              <div>
                <div className="mb-1 font-medium">Serial / Lot Number</div>
                <Input 
                  name="serialLotNumber"
                  placeholder="e.g., SN12345, LOT-A001" 
                  value={form.serialLotNumber}
                  onChange={handleInput}
                />
                <div className="text-xs text-muted-foreground mt-1">Optional</div>
              </div>
              <div>
                <div className="mb-1 font-medium">Grading Service</div>
                <Input 
                  name="gradingService"
                  ...
                  onChange={handleInput}
                />
                <div className="text-xs text-muted-foreground mt-1">Optional (if graded)</div>
              </div>
              <div>
                <div className="mb-1 font-medium">Grade</div>
                <Input 
                  name="grade"
                  placeholder="e.g., 10, 9.5, Mint" 
                  value={form.grade}
                  onChange={handleInput}
                />
                <div className="text-xs text-muted-foreground mt-1">Optional (if graded)</div>
              ...
              <div>
                <div className="mb-1 font-medium">Special Features</div>
                <Input 
                  name="specialFeatures"
                  placeholder="e.g., Misprint, Glow effect, Error" 
              ...
              <div>
                <div className="mb-1 font-medium">Original Packaging Status</div>
                <select 
                  name="originalPackagingStatus"
                  value={form.originalPackagingStatus}
                  onChange={handleInput}
              ...
              <div className="md:col-span-2">
                ...
                <RichTextEditor
                  ...
                  placeholder="Enter a detailed description of the collectible"
                  rows={5}
                />
...
export default AddNewCollectible;
