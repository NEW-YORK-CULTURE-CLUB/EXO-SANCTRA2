        ...
        >
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    <div className="flex items-center space-x-4 mb-4">
                      <Image
                        ...
                        width={100}
                        height={100}
                        className="opacity-90 lg:w-[100px] lg:h-[100px]"
                      />
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
                  <div className="relative h-80 lg:h-[600px] rounded-2xl overflow-hidden order-2 lg:order-1">
                    <Image
                  ...
                  <div className="space-y-4 lg:space-y-6 order-1 lg:order-2">
                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                      <Image
                        src="/vault/microchip.png"
                        alt="Microchip"
                        width={100}
                        height={100}
                        className="opacity-80 rounded-lg"
                      />
                      <span className="text-white/70">Microchips Activated</span>
                    </div>
                    <div className="hidden lg:block mt-4">
                      <Image
                        src="/vault/Start + Homepage/art altar.PNG"
                        alt="Art Altar"
                        width={200}
                        height={200}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                  {[
                    { 
                      ...
                      time: "",
                      tag: "Live Ceremony in New York City",
                    ...
                    { 
                      ...
                      time: "",
                      tag: "Interactive Art Experience",
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
                  ...
                  <div className="relative h-96 lg:h-[600px] rounded-2xl overflow-hidden order-1 lg:order-2">
                    <Image
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              ...
              >
                <div className="hidden lg:flex justify-center mb-6">
                  <Image
                    src="/vault/Characters for AR_Art Collection/Let Go.jpg"
                ...
                <h2 className="text-2xl lg:text-5xl font-bold text-white mb-4">
                  Essence <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">Hall</span>
                </h2>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              ...
              >
                <div className="hidden lg:flex justify-center mb-6">
                  <Image
                    src="/vault/Start + Homepage/ready to find your sanctuary_.png"
                    alt="Ready to find your sanctuary"
                    width={200}
                    height={200}
                    className=""
                    style={{ filter: 'hue-rotate(0deg) saturate(1.1) brightness(1.05)' }}
                  />
                </div>
                ...
                <p className="text-sm lg:text-lg text-white/80 mb-6 lg:mb-8 max-w-2xl mx-auto">
                  ...
                  <span className="hidden lg:inline"> Your journey of self-discovery and authentic connection starts here.</span>
                </p>
                <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 justify-center">
                  <Button 
