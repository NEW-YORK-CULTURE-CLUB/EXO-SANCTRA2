        ...
        >
          ...
          {heroLoading ? (
            ...
            <div className="relative min-h-screen flex items-center justify-center py-28 overflow-hidden">
              ...
              {/* <div className="w-full h-full bg-gradient-to-t from-black/50 to-black/60 absolute z-10"></div> */}
                ...
                {/* Bottom edge blur shadow for smooth transition */}
                <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black via-black/50 to-transparent z-[1] pointer-events-none"></div>
                  ...
                  <div className="grid lg:grid-cols-2 gap-6 lg:px-6 lg:gap-12 items-center justify-center">
                    ...
                    >
                      ...
                      <div className="hidden lg:block relative">
                        ...
                        >
                          {/* Outer glass frame */}
                          <div className="relative p-6 lg:p-8 backdrop-blur-xl bg-gradient-to-br from-white/20 via-white/10 to-white/5 rounded-[2.5rem] border border-white/30 ">
                            {/* Inner frame border */}
                            <div className="absolute inset-4 rounded-[2rem] border-2 border-white/20"></div>
                            
                            {/* Screen bezel effect */}
                            <div className="relative rounded-[1.5rem] overflow-hidden bg-black/20 backdrop-blur-sm border border-white/10">
          ...
          >
            ...
            />
            {/* Top edge blur shadow */}
            <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-black via-black/50 to-transparent z-[1] pointer-events-none"></div>
            {/* Bottom edge blur shadow */}
            <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black via-black/50 to-transparent z-[1] pointer-events-none"></div>
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              <motion.div 
                className="relative backdrop-blur-lg bg-[rgba(52,52,52,0.3)] border-0 border-white/20 rounded-3xl p-4 lg:p-12 shadow-2xl overflow-hidden max-w-7xl mx-auto"
                initial={{ opacity: 0, y: 50 }}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    ...
                    <p className="text-white/80 text-sm lg:text-lg">
                      ...
                      <span className=""> into a unified phygital universe. Created by Alina for souls who feel alien to society.</span>
                    </p>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              <motion.div 
                className="relative backdrop-blur-lg bg-[rgba(52,52,52,0.3)] border border-white/20 rounded-3xl p-4 lg:p-12 shadow-2xl overflow-hidden max-w-7xl mx-auto"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                  {[
                    ...
                    <motion.div
                      key={ritual.title}
                      className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:bg-white/15 transition-all cursor-pointer group"
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
              <motion.div 
                className="relative backdrop-blur-lg bg-[rgba(52,52,52,0.3)] border border-white/20 rounded-3xl p-4 lg:p-12 shadow-2xl overflow-hidden max-w-7xl mx-auto text-center"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                viewport={{ once: true }}
