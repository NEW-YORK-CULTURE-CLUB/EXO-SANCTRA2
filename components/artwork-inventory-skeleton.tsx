...
// Artwork Inventory Table Skeleton
export function ArtworkInventoryTableSkeleton() {
  return (
...
// Artwork Inventory Page Skeleton
export function ArtworkInventoryPageSkeleton() {
  return (
...
export function ArtworkDetailPageSkeleton() {
  return (
    <div className="min-h-screen bg-background -mt-5">
      {/* Header */}
...
// Add New Artwork Page Skeleton
export function AddNewArtworkPageSkeleton() {
  return (
    <div className="min-h-screen bg-background -mt-5">
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
