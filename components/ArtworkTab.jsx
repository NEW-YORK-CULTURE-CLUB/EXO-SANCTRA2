...
const ArtworkTab = ({
  ...
  // Filter and sort data specifically for artwork
  ...
  // Mobile card component for artwork
    ...
    <div className="bg-card border rounded-lg p-4 space-y-3 hover:shadow-md transition-shadow">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>{item.artist || 'N/A'}</span>
        </div>
      </div>

      {/* Artwork-specific Details Grid */}
      <div className="grid grid-cols-2 gap-3 text-sm">
        ...
        {visibleColumns.find(col => col.id === 'medium')?.checked && (
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium line-clamp-1">{item.medium || 'N/A'}</span>
          </div>
        )}
      ...
      {/* Artwork-specific fields: Color and Mood */}
      {(item.color || item.mood) && (
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4">
          <span className="text-xs lg:text-sm text-muted-foreground">
            {selectedArtworks.length} of {filteredData.length} artwork(s) selected.
          </span>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Color/Mood</TableHead>
