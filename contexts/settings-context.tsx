...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
  ...
  // Update email when gallery data is available
  useEffect(() => {
    if (gallery?.email && gallery.email !== settings.email) {
      updateSettings({ email: gallery.email });
    }
  }, [gallery?.email, settings.email])
